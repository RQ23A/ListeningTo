...
def set_cmd_line_opts ():
    ...
    cmd_line.add_option ("-t", "--time",    type="float", dest="time", default="10.0", help="Time frame for changing the status (in minutes).")
...
if __name__ == "__main__":
    ...
    if opt.daemon and start_daemon():
        ...
        while (1):
            # Run dbus script
            subprocess.call("/home/pablo/pythonstuff/ListeningTo/spotify.sh")
            # Set new status
            set_status (purple)
